...
export const FarcasterWalletStatus = () => {
  const { fid, username, wallet, connected, loading, isFarcasterEnvironment } = useFarcasterWallet();
    ...
    return (
      ...
      <div className="text-center">
        <p className="text-yellow-800 font-bold">
          {isFarcasterEnvironment && loading ? 'Loading Farcaster wallet...' : '🔗 Wallet Connection Required'}
        </p>
          <p className="text-yellow-700 text-sm mt-1">
            {isFarcasterEnvironment ? (
              'Please wait while we connect to your Farcaster wallet...'
            ) : (
              <a
