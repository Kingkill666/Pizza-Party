// Farcaster Wallet Integration QA Test Script v2
// Run this in the browser console to test the Farcaster wallet integration

console.log('🍕 Starting Pizza Party Farcaster Wallet QA Test v2...');
...
async function runAllTests() {
  console.log('🚀 Starting comprehensive Farcaster Wallet QA Test Suite v2...\n');
...
window.runFarcasterQATestV2 = runAllTests;
...
console.log('🍕 Farcaster QA Test Script v2 loaded!');
console.log('💡 Run "runFarcasterQATestV2()" to start comprehensive testing');
